...
/**
 * <p>
 * The {@link com.pixelmed.database.DatabaseInformationModel DatabaseInformationModel} class is an abstract class that contains the core
 * functionality for storing, accessing and maintaining a persistent representation of selected attributes of composite
 * objects.</p>
 *
 * <p>
 * It hides an underlying SQL database implementation that stores the attributes of each
 * entity in the information model in tables.</p>
 *
 * <p>
 * Abstract sub-classes, such as {@link com.pixelmed.database.DicomDatabaseInformationModel DicomDatabaseInformationModel},
 ...
 *
 * <p>
 * For example, an application might instantiate a {@link com.pixelmed.database.PatientStudySeriesConcatenationInstanceModel PatientStudySeriesConcatenationInstanceModel}
 ...
 *
 * <p>
 * Composite objects previously read into a {@link com.pixelmed.dicom.AttributeList AttributeList} from a
 ...
 * case a tool like {@link org.hsqldb.util.DatabaseManagerSwing org.hsqldb.util.DatabaseManagerSwing} (described in detail at <a href="http://www.hsqldb.org/doc/guide/apf.html">Hsqldb User Guide:
 * Appendix F. Database Manager</a>) can be used to query or manage the database. For example:</p>
 * <pre>
 * % java -cp lib/additional/hsqldb.jar org.hsqldb.util.DatabaseManagerSwing --url "jdbc:hsqldb:hsql://hostname/databaseServerName"
 * </pre>
 *
 * <p>
 * where "hostname" is the name of the host (perhaps "localhost"), and "databaseServerName" is the name supplied in the constructor.</p>
 *
 * <p>
 * Note that the default username ("sa") and password (empty) are not secure.</p>
 *
...
public abstract class DatabaseInformationModel
{
  ...
  private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/database/DatabaseInformationModel.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
  ...
  {			// package scope ... used by DatabaseTreeBrowser
    return localColumnExcludeList;
  }

  /**
   * <p>
   * Return a list of (upper case) column names not to include in human-readable renderings like browsers.</p>
   *
   * <p>
   * Includes such things as the internal primary and parent keys, record insertion time, local file names.</p>
   */
  /*protected*/ void makeLocalColumnExcludeList()
  {		// protected scope ... may be (but isn't currently) overridden by specialized classes
  ...
  /**
   * <p>
   * Instantiate a persistent information model using the named database.</p>
   *
   * <p>
   * Will open a connection to the database, and create any tables if this is the first time,
   ...
   */
  public DatabaseInformationModel(String databaseFileName, InformationEntity rootInformationEntity, DicomDictionary dictionary)
   ...
   * @exception	DicomException	thrown if a connection to the database cannot be established
   */
  public DatabaseInformationModel(String databaseFileName, InformationEntity rootInformationEntity, DicomDictionary dictionary, String databaseRootName)
     throws DicomException
  {
  ...
  /**
   * <p>
   * Instantiate a persistent information model using the named database allowing external SQL access.</p>
   *
   * <p>
   * Will open a connection to the database, and create any tables if this is the first time,
   * or re-use any persistent information if not.</p>
   ...
   * @exception	DicomException	thrown if a connection to the database cannot be established
   */
  public DatabaseInformationModel(String databaseFileName, String databaseServerName, InformationEntity rootInformationEntity, DicomDictionary dictionary)
     throws DicomException
  {
   ...
   * @exception	DicomException	thrown if a connection to the database cannot be established
   */
  public DatabaseInformationModel(String databaseFileName, String databaseServerName, InformationEntity rootInformationEntity, DicomDictionary dictionary, String databaseRootName)
     throws DicomException
  {
...
//System.err.println("DatabaseInformationModel.doCommonConstructorStuff(): attempting to start external database server named = "+databaseServerName);
  ...
  /**
   * <p>
   * Close the underlying connection to the database and shutdown any external SQL server.</p>
   *
   * <p>
   * Prior to actually closing will also try to formally shutdown and compact the database.</p>
   */
  public void close()
  {
...
//System.err.println("DatabaseInformationModel.close(): shutdown compact finished");
  ...
  /**
   * <p>
   * Get the entity that is at the top of the information model.</p>
   *
   * <p>
   * May be used, for example, to begin top-down traversal of a composite object, or the entire database.</p>
   *
   * <p>
   * Will be specific to a particular concrete information model.</p>
   *
  ...
  {
    return rootInformationEntity;
  }

  /**
   * <p>
   * Is the entity in the information model ? </p>
   *
   * <p>
   * Will be specific to a particular concrete information model.</p>
   *
  ...
  /**
   * <p>
   * Is the named entity in the information model ? </p>
   *
   * <p>
   * Will be specific to a particular concrete information model.</p>
   *
  ...
  /**
   * <p>
   * Get the map of attribute (table column) names to descriptive names.</p>
   *
   * <p>
   * May be used, for example, for column header labels in table browsers.</p>
   *
   ...
   */
  private void createDescriptiveNameMap()
     throws DicomException
  {
  ...
  /**
   * <p>
   * Get the name of the table column corresponding to the DICOM tag.</p>
   *
  ...
  /**
   * <p>
   * Get the name of the table column corresponding to the DICOM element name.</p>
   *
  ...
  /**
   * <p>
   * Get the name of the DICOM element corresponding to the database table column.</p>
   *
   ...
   * @exception	DicomException
   */
  private void createTable(InformationEntity ie, boolean withParentReference)
     throws DicomException
  {
  ...
  /**
   * <p>
   * Create any additional indexes to optimize queries, for example for UIDs.</p>
   *
   * <p>
   * Called after creating tables and default indexes.</p>
   */
...
//System.err.println("extendCreateStatementStringWithPersonNameSearchColumns(): columnName = "+columnName+" tableName = "+tableName);
  ...
  /**
   * <p>
   * Extend a SQL CREATE TABLE statement in the process of being constructed with any additional attributes (columns) that the model requires.</p>
   *
   * <p>
   * Called when creating the tables for a new database.</p>
   *
   * <p>
   * Specific to each concrete information model extending {@link com.pixelmed.database.DatabaseInformationModel DatabaseInformationModel}.
  ...
  /**
   * <p>
   * Extend a SQL CREATE TABLE statement in the process of being constructed with any derived attributes (columns) that the model requires.</p>
   *
   * <p>
   * Called when creating the tables for a new database.</p>
   *
   ...
   *
   * <p>
   * For example, there may be dates and times derived from DICOM attributes.</p>
   *
   * @param	b	the statement being constructed
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity} for which a create table statement is being constructed
   */
  ...
  /**
   * <p>
   * Extend a SQL CREATE TABLE statement in the process of being constructed with any user optional columns that the model requires.</p>
   *
   * <p>
   * Called when creating the tables for a new database.</p>
   *
  ...
  {
    b.append(", ");
    b.append(userColumnName1);
    b.append(" ");
    b.append("VARCHAR");
    b.append(", ");
    b.append(userColumnName2);
    b.append(" ");
    b.append("VARCHAR");
    b.append(", ");
    b.append(userColumnName3);
    b.append(" ");
    b.append("VARCHAR");
    b.append(", ");
    b.append(userColumnName4);
    b.append(" ");
    b.append("VARCHAR");
  }
   ...
   * @exception	DicomException
   */
  private void extendTablesAsNecessary(AttributeList list)
     throws DicomException
  {		// doesn't work with Hypersonic ... ALTER command not supported :(
...
//System.err.println(a.toString()+" "+columnName+" = "+tableName+" "+columnType+" "+isAttributeUsedInTable(tableName,columnName));
   ...
   */
  @Deprecated
  public void deleteSelectedRecord(InformationEntity ie, String localPrimaryKeyValue)
     throws DicomException
  {
  ...
  /**
   * <p>
   * Delete a database record (a particular instance of an information entity).</p>
   *
   * <p>
   * For example, for the study entity, this would delete a particular study.</p>
   *
   * <p>
   * Does NOT delete its children, if any.</p>
   *
   * <p>
   * Does NOT delete any referenced files, if any.</p>
   *
   ...
   */
  public void deleteRecord(InformationEntity ie, String localPrimaryKeyValue)
     throws DicomException
  {
...
//System.err.println("DatabaseInformationModel.deleteRecord(): Statement to execute = "+ss);
  ...
  /**
   * <p>
   * Insert a DICOM composite object, and the relevant attributes of all the entities it contains, into the database.</p>
   *
   * <p>
   * Such a composite object may contain information about the patient, study, series and
   ...
   *
   * <p>
   * The information is taken from the supplied {@link com.pixelmed.dicom.AttributeList AttributeList},
   ...
   *
   * <p>
   * The file reference type is left empty since unknown.</p>
   *
   ...
   */
  @Deprecated
  public void insertObject(AttributeList list, String fileName)
     throws DicomException
  {
   ...
   * @exception	DicomException	thrown if there are problems extracting the DICOM attributes
   */
  public void insertObject(AttributeList list, String fileName, String fileReferenceType)
     throws DicomException
  {
...
//System.err.println("DatabaseInformationModel.insertObject(): ie="+ie+" count="+count+" entityPrimaryKey="+entityPrimaryKey);
        if(count != 1 || entityPrimaryKey == null)
        {	// too few or too many ... make a new entry ...
...
//System.err.println("DatabaseInformationModel.insertObject(): Done "+tableName+" entityPrimaryKey="+entityPrimaryKey+" localParentReference="+localParentReference);
   ...
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
   * <p>
   * Specific to each concrete information model extending {@link com.pixelmed.database.DatabaseInformationModel DatabaseInformationModel}.</p>
   *
   * @param	b	the statement being constructed
   * @param	list	the DICOM attributes of a composite object, containing the attributes describing this instance of the entity
  ...
  /**
   * <p>
   * Extend a SQL SELECT statement in the process of being constructed with matching clauses for the unique keys of the entity and all its parents.</p>
   *
   * <p>
   * For example, a model might specify the unique key for the patient to be <code>PatientID</code>,
  ...
  /**
   * <p>
   * Extend a SQL INSERT statement in the process of being constructed with the names of the attributes in the instance for the entity.</p>
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
  ...
  /**
   * <p>
   * Extend a SQL INSERT statement in the process of being constructed with the values of the attributes in the instance for the entity.</p>
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
   ...
   *
   * @deprecated use
   * {@link #extendInsertStatementStringWithAttributeValuesForSelectedInformationEntity(StringBuffer,AttributeList,InformationEntity,String,String) extendInsertStatementStringWithAttributeValuesForSelectedInformationEntity()}
   * instead
   *
   * @param	b	the statement being constructed
   * @param	list	the DICOM attributes of a composite object, containing the attributes describing this instance of the entity
   ...
   * @exception	DicomException	thrown if there are problems extracting the DICOM attributes
   */
  protected abstract void extendInsertStatementStringWithAttributeValuesForSelectedInformationEntity(StringBuffer b, AttributeList list, InformationEntity ie, String fileName, String fileReferenceType)
     throws DicomException;

  /**
   * <p>
   * Extend a SQL INSERT statement in the process of being constructed with the names of the derived attributes in the instance for the entity.</p>
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
  ...
  /**
   * <p>
   * Extend a SQL INSERT statement in the process of being constructed with the values of the derived attributes in the instance for the entity.</p>
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
  ...
  /**
   * <p>
   * Create a new unique key which may be used to identify a new instance of an entity.</p>
   *
   * <p>
   * Called when inserting a new record for an instance of the entity.</p>
   *
   ...
   */
  private void primeListsOfAttributesByInformationEntityFromExistingMetaData()
     throws SQLException
  {
...
//System.err.println("DatabaseInformationModel.primeListsOfAttributesByInformationEntityFromExistingMetaData(): adding to table "+tableName+" "+columnName);
  ...
  /**
   * <p>
   * Is the specified attribute (column) recorded in the specified entity?</p>
   *
  ...
  /**
   * <p>
   * Is the specified attribute (column) recorded in the specified table?</p>
   *
...
//System.err.println("DatabaseInformationModel.isAttributeUsedInTable(String,String): "+tableName+" does not contain "+columnName);
  ...
  /**
   * <p>
   * For a particular instance of an information entity, update the record in the database table with a new value for the specified attribute (column).</p>
   *
   * <p>
   * For example, for the study entity, this would update an attribute of a particular study, for example the <code>StudyID</code> attribute.</p>
   *
   ...
   */
  public void updateSelectedRecord(InformationEntity ie, String localPrimaryKeyValue, String key, String value)
     throws DicomException
  {
//System.err.println("DatabaseInformationModel.updateSelectedRecord(): "+ie+" "+localPrimaryKeyValue+" "+key+" "+value);
  ...
  /**
   * <p>
   * For a particular instance of an information entity, get the values of all the columns in the entity's database table.</p>
   *
   * <p>
   * For example, for the study entity, this would return the attributes for a particular study.</p>
   *
   ...
   */
  public Map findAllAttributeValuesForSelectedRecord(InformationEntity ie, String localPrimaryKeyValue)
     throws DicomException
  {
...
//System.err.println("findAllAttributeValuesForSelectedRecord: ["+i+"] key = "+key+" value = "+value);
  ...
  /**
   * <p>
   * For all records of an information entity, get the values of all the columns in the entity's database table.</p>
   *
   * <p>
   * For example, for the study entity, this would return the attributes for all the studies in the database.</p>
   *
...
//System.err.println("Select all values for all records of "+ie.toString()+" time "+(System.currentTimeMillis()-startTime)+" milliseconds");
  ...
  /**
   * <p>
   * For all records of an information entity matching the specified UID, get the values of all the columns in the entity's database table.</p>
   *
   * <p>
   * For example, for the study entity, this would return the attributes for all the studies with the specified UID in the database.</p>
   *
   * <p>
   * For the instance entity, this would return the attributes for all the instances with the specified UID in the database.</p>
   *
   * <p>
   * In an ideal world, this method should only ever return one record, since the DICOM model is predicated on UIDs being unique !</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity} of the records to be returned
   ...
   * @exception	DicomException	thrown if the query fails
   */
  public ArrayList findAllAttributeValuesForAllRecordsForThisInformationEntityWithSpecifiedUID(InformationEntity ie, String uid)
     throws DicomException
  {
  ...
  /**
   * <p>
   * For all records of an information entity matching the specified key value, get the values of all the columns in the entity's database table.</p>
   *
   * <p>
   * For example, for the study entity, this would return the attributes for all the studies with the specified key value in the database.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity} of the records to be returned
   ...
   * @exception	DicomException	thrown if the query fails
   */
  public ArrayList findAllAttributeValuesForAllRecordsForThisInformationEntityWithSpecifiedKeyValue(InformationEntity ie, String keyName, String keyValue)
     throws DicomException
  {
//long startTime=System.currentTimeMillis();
    ArrayList recordsAsMapsOfStrings = new ArrayList();
...
//System.err.println("Select all values for all records of "+ie.toString()+" time "+(System.currentTimeMillis()-startTime)+" milliseconds");
  ...
  private final String[] getArrayOfColumnNamesForSpecifiedInformationEntity(InformationEntity ie, ResultSet r)
     throws java.sql.SQLException
  {
...
//System.err.println("getArrayOfColumnNamesForSpecifiedInformationEntity() "+ie.toString()+" caching metadata");
  ...
  /**
   * <p>
   * For all records of an information entity with the specified parent, get the values of all the columns in the entity's database table.</p>
   *
   * <p>
   * For example, for the series entity, this would return the attributes for all the series of a particular study (parent).</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity} of the records to be returned
   ...
   * @exception	DicomException	thrown if the query fails
   */
  public ArrayList findAllAttributeValuesForAllRecordsForThisInformationEntityWithSpecifiedParent(InformationEntity ie, String localParentReference)
     throws DicomException
  {
//long startTime=System.currentTimeMillis();
    ArrayList recordsAsMapsOfStrings = new ArrayList();
...
//System.err.println("Select all values for all records of "+ie.toString()+" with specified parent time "+(System.currentTimeMillis()-startTime)+" milliseconds");
  ...
  /**
   * <p>
   * For all records of an information entity with all parents matching a particular attribute value, get the values of all attributes.</p>
   *
   * <p>
   * For example, for the instance entity, this could return the instance local file name for all the series (parents) with a particular frame of reference UID.</p>
   *
  ...
  public ArrayList findAllAttributeValuesForAllRecordsForThisInformationEntityWithMatchingParent(
     InformationEntity ieWanted, InformationEntity ieParent, String parentMatchingAttribute, String parentMatchingValue)
     throws DicomException
  {
//long startTime=System.currentTimeMillis();
    ArrayList recordsAsMapsOfStrings = new ArrayList();
...
//System.err.println("Select all values for all records of "+ieWanted.toString()+" with matching parent time "+(System.currentTimeMillis()-startTime)+" milliseconds");
  ...
  /**
   * <p>
   * Get the table name for an information entity.</p>
   *
  ...
  /**
   * <p>
   * For an information entity (regardless of a particular instance), find the next information entity lower down in the information model hierarchy in the general case.</p>
   *
   * <p>
   * For a patient, this might be a study.</p>
   * <p>
   * For a series, this might be a concatenation
   * or an instance, depending on the information model.
   *
   * <p>
   * This method essentially returns the most complex model possible and is used when building the database table schema.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity} that is the parent, such as a patient, study, etc.
  ...
  /**
   * <p>
   * For a particular instance of an information entity, find the next information entity lower down in the information model hierarchy.</p>
   *
   * <p>
   * For a patient, this might be a study. For a series, this might be a concatenation
   * or an instance, depending on both the information model and whether concatenations are to be considered in the model.
   *
   * <p>
   * This method may return a simpler view than the more general method, and is used when traversing the database tables.</p>
   *
  ...
  /**
   * <p>
   * For a particular instance of an information entity, find a descriptive name for the entity suitable for rendering.</p>
   *
   * <p>
   * For a patient, this might be the name <code>Patient</code>.
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the first of three descriptive attributes for the entity.</p>
   *
   * <p>
   * For example, for an instance (e.g. an image), this might be the <code>InstanceNumber</code>.
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the second of three descriptive attributes for the entity.</p>
   *
   * <p>
   * For example, for an instance (e.g. an image), this might be the <code>InConcatenationNumber</code>.
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the third of three descriptive attributes for the entity.</p>
   *
   * <p>
   * For example, for an instance (e.g. an image), this might be the <code>ImageComments</code>.
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the DICOM UID for the entity.</p>
   *
   * <p>
   * For example, for an instance (e.g. an image), this might be the name of the column corresponding to the SOP Instance UID.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the primary key of an instance of the entity.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
   * patient, study, etc.
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the local file name of a stored object.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
   ...
   */
  @Deprecated
  public String localFileNameColumnName(InformationEntity ie)
  {
    return getLocalFileNameColumnName(ie);
  }

  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the reference type of a stored object.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
   * instance (e.g. an image)
   * @return	the upper case string name of the column
  ...
  /**
   * <p>
   * For a particular information entity, find the name of the column in the entity's database table containing the reference to an instance of the entity's parent.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
   * patient, study, etc.
   * @return	the upper case string name of the column
   ...
   * {@link java.lang.System#currentTimeMillis() System.currentTimeMillis()}.</p>
   *
   * @param	ie	the {@link com.pixelmed.dicom.InformationEntity InformationEntity}, such as a
   * patient, study, etc.
   * @return	the upper case string name of the column
  ...
  /**
   * <p>
   * Given a DICOM Value Representation, determine the appropriate corresponding SQL type to use.</p>
   *
   * <p>
   * For example, the DICOM AE VR should be represented as a CHAR(16), an SS as an INTEGER, and so on.</p>
   *
  ...
  /**
   * <p>
   * Get a factory to manufacture a query response generator capable of performing a query and returning the results.</p>
   *
...
//System.err.println("DatabaseInformationModel.getQueryResponseGeneratorFactory():");
  ...
  /**
   * <p>
   * Get a factory to manufacture a retrieve response generator capable of performing a retrieve and returning the results.</p>
   *
   * @param	debugLevel	zero for no debugging messages, higher values more verbose messages
   * @return	the response generator factory
   */
...
//System.err.println("DatabaseInformationModel.getRetrieveResponseGeneratorFactory():");
  ...
  /**
   * <p>
   * Returns a string describing the structure (not the contents) of the database.</p>
   *
  ...
  public String toString()
  {
    ...
    try
    {
      ...
      while(columns.next())
      {
        ...
        buffer.append(columns.getString(1));
        buffer.append("; ");
        buffer.append("schema  = ");
        buffer.append(columns.getString(2));
        buffer.append("; ");
        buffer.append("table   = ");
        buffer.append(columns.getString(3));
        buffer.append("; ");
        buffer.append("column  = ");
        buffer.append(columns.getString(4));
        buffer.append("; ");
        buffer.append("type    = ");
        buffer.append(columns.getString(6));
        buffer.append("; ");
        buffer.append("size    = ");
        buffer.append(columns.getInt(7));
        buffer.append("; ");
        buffer.append("\n");
      }
