...
public class DatabaseTreeModel implements TreeModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/database/DatabaseTreeModel.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
