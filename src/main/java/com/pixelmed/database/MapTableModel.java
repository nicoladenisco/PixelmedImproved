...
public class MapTableModel extends AbstractTableModel {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/database/MapTableModel.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
...
//System.err.println("MapTableModel.isAcceptable(): checking "+name+" is in exclude list "+excludeList.contains(name.toUpperCase()));
		return name != null && (excludeList == null || !excludeList.contains(name.toUpperCase()));
	}
