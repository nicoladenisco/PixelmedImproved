...
public class PatientStudySeriesConcatenationInstanceModel extends DicomDatabaseInformationModel {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/database/PatientStudySeriesConcatenationInstanceModel.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
