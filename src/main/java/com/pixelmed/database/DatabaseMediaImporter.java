...
public class DatabaseMediaImporter extends MediaImporter {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/database/DatabaseMediaImporter.java,v 1.2 2011-06-16 11:23:00 nicola Exp $";
...
//System.err.println("DatabaseMediaImporter:doSomethingWithDicomFile(): "+mediaFileName);
		try {
			...
			String localCopyFileName=storedFilePathStrategy.makeReliableStoredFilePathWithFoldersCreated(null, savedInstancesFolder,sopInstanceUID).getPath();
