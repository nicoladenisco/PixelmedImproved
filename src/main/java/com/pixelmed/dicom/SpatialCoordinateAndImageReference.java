...
public class SpatialCoordinateAndImageReference {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/SpatialCoordinateAndImageReference.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
...
//System.err.println("SpatialCoordinateAndImageReference.SpatialCoordinateAndImageReference(): "+this);
	}
	...
	/**
	 * <p>Get rendering intent as String.</p>
	 *
	 * @return
	 */
