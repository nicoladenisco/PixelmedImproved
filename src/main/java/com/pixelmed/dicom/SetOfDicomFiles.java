...
public class SetOfDicomFiles extends HashSet
{
  private static final String identString =
     "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/SetOfDicomFiles.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
  private HashSet setOfSOPClassUIDs = new HashSet();

  public Set getSetOfSOPClassUIDs()
  {
    return setOfSOPClassUIDs;
  }
  ...
  public class DicomFile implements Comparable
  {
    ...
    {
      return fileName == null ? (((DicomFile) o).fileName == null ? 0 : -1)
             : fileName.compareTo(((DicomFile) o).fileName);
    }
   ...
   */
  public DicomFile add(File file)
     throws IOException
  {
