...
/**
 * <p>
 * A class to extract and describe the spatial geometry of a single cross-sectional image slice, given a list of DICOM attributes.</p>
 *
 * @author	dclunie
 */
public class GeometryOfSliceFromAttributeList extends GeometryOfSlice
{
  private static final String identString
     = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/GeometryOfSliceFromAttributeList.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";

  /**
   * <p>
   * Construct the geometry from the Image Plane Module and related attributes.</p>
   *
     ...
     throws DicomException
  {
    ...
    dim[0] = Attribute.getSingleIntegerValueOrDefault(list, TagFromName.Rows, 0);
    dim[1] = Attribute.getSingleIntegerValueOrDefault(list, TagFromName.Columns, 0);
    dim[2] = 1;
    ...
    this.dimensions = new Vector3d(dim);
    makeNormal();
  }
}
