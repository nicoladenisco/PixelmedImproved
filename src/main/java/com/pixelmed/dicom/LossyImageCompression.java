...
public class LossyImageCompression {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/LossyImageCompression.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
...
//System.err.println("Checking DerivationDescription "+Attribute.getDelimitedStringValuesOrEmptyString(list,TagFromName.DerivationDescription).toLowerCase().indexOf("lossy"));
...
//System.err.println("Checking TransferSyntaxUID lossy "+new TransferSyntax(Attribute.getSingleStringValueOrEmptyString(list,TagFromName.TransferSyntaxUID)).isLossy());
		return Attribute.getSingleIntegerValueOrDefault(list,TagFromName.LossyImageCompression,-1) > 0
		    ...
		    || Attribute.getDelimitedStringValuesOrEmptyString(list,TagFromName.DerivationDescription).toLowerCase().indexOf("lossy") > -1
