...
/**
 * <p>
 * A class for generating new UIDs, deterministically or not,
 * including potentially reproducible Study, Series and SOP Instance UIDs.</p>
 *
 * @author	dclunie
 */
public class UIDGenerator
{
  private static final String identString
     = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/UIDGenerator.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
  ...
  private static final String root
     = VersionAndConstants.uidRoot + "."
     + VersionAndConstants.uidQualifierForThisToolkit + "."
     + VersionAndConstants.uidQualifierForUIDGenerator;

  private static final int maxStampComponentLength = 64
     - root.length() - 1 // root .
     - 3 // . in generated stamp
     - 2 // . UIDGEN_XXX (would need to be three if > 9)
     - 5 - 5 - 5;		// . SOP Instance UID study# (4) . series# (4) . instance# (4)

  private static final int maxLongStampComponentLength = 64
     - root.length() - 1 // root .
     - 3 // . in generated stamp
     - 2 // . UIDGEN_XXX (would need to be three if > 9)
  ...
  /**
   * <p>
   * Create a UID generator.</p>
   *
   * <p>
   * This will use random and installation specific elements to create a unique root.</p>
   *
   */
  public UIDGenerator()
  {
...
//System.err.println("UIDGenerator(): machineAddress="+machineAddress);
   ...
   *
   * <p>
   * For example, use between invocations of getNewUID().</p>
   *
   */
...
//System.err.println("stamp length > maximum which is "+maxStampComponentLength+" shortening MAC specific string");
   ...
   *
   * <p>
   * This will use the supplied stamp rather than generating a unique root, to create repeatable UIDs.</p>
   *
  ...
  /**
   * <p>
   * Get a new UID for any purpose.</p>
   *
   * <p>
   * This will always be the same for this instance of the UIDGenerator, unless newStamp() has been called since the last time.</p>
   *
   * @return	the UID
  ...
  /**
   * <p>
   * Get a different new UID for any purpose.</p>
   *
   * <p>
   * This will never be the same twice, since newStamp() is called.</p>
   *
   * @return	the UID
   * @exception	DicomException	if result is too long or otherwise not a valid UID
   */
  ...
  /**
   * <p>
   * Get a Study Instance UID.</p>
   *
   * <p>
   * This will be the same for this instance of the UIDGenerator and the same parameter values.</p>
   *
   * <p>
   * Only use this if you really need reproducible UIDs; otherwise use getNewUID().</p>
   *
...
//System.err.println("uid=\""+uid+"\"");
  ...
  private static final void validateUID(String uid)
     throws DicomException
  {
    if(uid.length() > 64)
    {
