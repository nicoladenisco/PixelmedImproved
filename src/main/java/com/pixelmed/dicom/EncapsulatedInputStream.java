...
public class EncapsulatedInputStream extends InputStream {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/EncapsulatedInputStream.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
