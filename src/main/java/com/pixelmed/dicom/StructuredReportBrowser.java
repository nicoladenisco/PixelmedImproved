...
/**
 * <p>
 * The {@link com.pixelmed.dicom.StructuredReportBrowser StructuredReportBrowser} class implements a Swing graphical user interface
...
{
  private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/StructuredReportBrowser.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
  ...
  /**
   * <p>
   * Build and display a graphical user interface view of a tree representing a structured reports.</p>
   *
   * <p>
   * Implicitly builds a tree from the attribute list.</p>
   *
   * @param	list	the list of attributes in which the structured report is encoded
   * @exception	DicomException
   */
  public StructuredReportBrowser(AttributeList list)
   ...
   * @exception	DicomException
   */
  public StructuredReportBrowser(AttributeList list, String title)
     throws DicomException
  {
    super(title);
...
//System.err.println("Selected: "+tp);
          ...
          if(rootComponent instanceof ContentItem && lastPathComponent instanceof ContentItem)
          {
            ...
            if(instances != null)
              doSomethingWithSelectedSOPInstances(instances);
          }
        }
      }
    };
  ...
  /**
   * <p>
   * Do something when the user selects a node of the tree.</p>
   *
   * <p>
   * Override this method in derived classes to do something useful.</p>
   *
   * @param	instances
   */
   ...
   *
   * <p>
   * Display the SR encoded in the file name on the command line as a tree.</p>
   *
   * @param	arg
   */
