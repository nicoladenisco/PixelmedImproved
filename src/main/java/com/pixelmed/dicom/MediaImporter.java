...
public class MediaImporter {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/MediaImporter.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
	...
	public void importDicomFiles(String pathName) throws IOException, DicomException {
		if (pathName != null) {
			...
			if (path != null && path.exists()) {
				if (path.isFile() && path.getName().toUpperCase().equals("DICOMDIR")) {
					dicomdirFile=path;
				}
