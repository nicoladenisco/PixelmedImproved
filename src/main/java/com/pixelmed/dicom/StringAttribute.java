...
abstract public class StringAttribute extends Attribute {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/dicom/StringAttribute.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
