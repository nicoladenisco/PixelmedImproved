...
public class Syslog {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/utils/Syslog.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
	...
	public int getFacilityByName(String s) {
		return ((Integer)(facilityByName.get(s.toLowerCase()))).intValue();
	}
	...
	public int getPriorityByName(String s) {
		return ((Integer)(priorityByName.get(s.toLowerCase()))).intValue();
	}
