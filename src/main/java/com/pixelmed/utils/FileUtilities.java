...
public class FileUtilities
{
  private static final String identString =
     "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/utils/FileUtilities.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
   ...
   */
  public static void renameElseCopyTo(File srcFile, File dstFile)
     throws IOException
  {
...
//System.err.println("FileUtilities.renameElseCopyTo(): renaming failed, so copy instead");
      CopyStream.copy(srcFile, dstFile); //System.err.println("FileUtilities.renameElseCopyTo(): copying succeeded");
  }
   ...
   */
  public static ArrayList listFilesRecursively(File initialPath)
  {
...
//System.err.println("FileUtilities.listFilesRecursively(): found "+filesAndDirectories[i]);
   ...
   */
  public static File getFileFromNameInsensitiveToCaseIfNecessary(String fileName)
...
//System.err.println("FileUtilities.getFileFromNameInsensitiveToCaseIfNecessary(): Trying "+file);
                if(!file.exists())
                {
                  file = new File(root, name.toLowerCase());
//System.err.println("FileUtilities.getFileFromNameInsensitiveToCaseIfNecessary(): Trying "+file);
                  if(!file.exists())
                  {
                    file = new File(root, name.toUpperCase());
//System.err.println("FileUtilities.getFileFromNameInsensitiveToCaseIfNecessary(): Trying "+file);
                    if(!file.exists())
...
//System.err.println("FileUtilities.getFileFromNameInsensitiveToCaseIfNecessary(): Found "+file);
  ...
  {
    String fileName = new java.rmi.server.UID().toString().replaceAll("[^A-Za-z0-9 ]", "_").toUpperCase() + ".tmp";
    return fileName;
  }
   ...
   */
  public static String makePathToFileInUsersHomeDirectory(String fileName)
  {
   ...
   * @return				string representation of the digest
   */
  static public final String md5(String fileName)
     throws IOException, NoSuchAlgorithmException
  {
