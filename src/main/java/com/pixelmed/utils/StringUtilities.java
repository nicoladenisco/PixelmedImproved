...
public class StringUtilities
{
  private static final String identString =
     "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/utils/StringUtilities.java,v 1.2 2011-12-08 18:29:34 nicola Exp $";
  private static Collator ourCollator = Collator.getInstance();

  static
  {
    ourCollator.setStrength(Collator.IDENTICAL);
    ourCollator.setDecomposition(Collator.FULL_DECOMPOSITION);
  }
   ...
   */
  static public String replaceAllInWith(String string, String oldChars, String newChars)
  {
   ...
   */
  static public boolean contains(String string, String[] substrings)
  {
   ...
   * @return				true if any string in substrings is found within string
   */
  static public boolean containsRegardlessOfCase(String string, String[] substrings)
  {
    if(string != null && substrings != null)
    {
   ...
   */
  static public Vector getDelimitedValues(String string, String delimiter)
  {
    Vector r = new Vector();
    ...
    while(t.hasMoreTokens())
    {
      ...
      if(v.equals(delimiter))
      {		// consecutive delimiters (and start) means null value
        if(lastWasDelimiter)
        {
          r.add("");
        }
   ...
   */
  static public String removeTrailingCharacter(String src, char rmchar)
  {
   ...
   */
  static public String removeTrailingWhitespaceOrISOControl(String src)
  {
    char[] c = src.toCharArray();
    int l = c.length;
    int n = l;
    while(n > 0 && (Character.isWhitespace(c[n - 1]) || Character.isISOControl(c[n - 1])))
      --n;
    return n == l ? src : (n > 0 ? new String(c, 0, n) : "");
  }
   ...
   */
  static public String removeLeadingCharacter(String src, char rmchar)
  {
    char[] c = src.toCharArray();
    int l = c.length;
    int i = 0;
    while(i < l && c[i] == rmchar)
      ++i;
   ...
   * @return		the value of the string argument with any instances of trailing whitespace or control characters removed
   */
  public static String removeLeadingWhitespaceOrISOControl(String src)
  {
    char[] c = src.toCharArray();
    int l = c.length;
    int i = 0;
    while(i < l && (Character.isWhitespace(c[i]) || Character.isISOControl(c[i])))
      ++i;
    return i == 0 ? src : (i < l ? new String(c, i, l - i) : "");
  }
   ...
   */
  static public String removeTrailingSpaces(String src)
  {
   ...
   */
  static public String removeLeadingSpaces(String src)
  {
   ...
   */
  static public String removeLeadingOrTrailingWhitespaceOrISOControl(String src)
  {
   ...
   */
  static public int compareStringsThatMayBeIntegers(String s1, String s2)
  {
    try
    {
...
//System.err.println("compareStringsThatMayBeIntegers: falling back to string");
   ...
   */
  static public int compareStringsWithEmbeddedNonZeroPaddedIntegers(String s1, String s2)
  {
  ...
  public static Date mergeDateTime(Date dp, Date tp)
  {
