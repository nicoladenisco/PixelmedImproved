...
public class CMoveRequestCommandMessage extends RequestCommandMessage {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/network/CMoveRequestCommandMessage.java,v 1.2 2011-08-10 18:14:19 nicola Exp $";
