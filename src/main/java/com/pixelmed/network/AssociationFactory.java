...
public class AssociationFactory
{
   ...
   */
  static public int getDefaultMaximumLengthReceived()
  {
   ...
   */
  static public int getDefaultReceiveBufferSize()
  {
   ...
   */
  static public int getDefaultSendBufferSize()
  {
     ...
     throws DicomNetworkException, IOException
  {
    ...
    aa.negoziateAssociation(socket, calledAETitle,
       VersionAndConstants.implementationClassUID,
       VersionAndConstants.implementationVersionName,
       ourMaximumLengthReceived, socketReceiveBufferSize, socketSendBufferSize,
       new UnencapsulatedExplicitStoreFindMoveGetPresentationContextSelectionPolicy(), null);
     ...
     throws DicomNetworkException, IOException
  {
    ...
    aa.negoziateAssociation(socket, calledAETitle,
       ...
       getDefaultReceiveBufferSize(),
       getDefaultSendBufferSize(),
       presentationContextSelectionPolicy, null);
