 ...
 * @author	dclunie
 */
class CStoreRequestCommandMessage extends RequestCommandMessage
{
  private static final String identString =
     "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/network/CStoreRequestCommandMessage.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
  private byte bytes[];
     ...
     throws DicomException, IOException
  {
    ...
    moveOriginatorApplicationEntityTitle =
       Attribute.getSingleStringValueOrNull(list, TagFromName.MoveOriginatorApplicationEntityTitle);
   ...
   * @exception	DicomException
   */
  public CStoreRequestCommandMessage(String affectedSOPClassUID, String affectedSOPInstanceUID)
     throws DicomException, IOException
  {
     ...
     throws DicomException, IOException
  {
    ...
    {
      AttributeTag t = TagFromName.MoveOriginatorApplicationEntityTitle;
      Attribute a = new ApplicationEntityAttribute(t);
      a.addValue(moveOriginatorApplicationEntityTitle);
      list.put(t, a);
    }
    if(moveOriginatorMessageID != -1)
    {
      AttributeTag t = TagFromName.MoveOriginatorMessageID;
      Attribute a = new UnsignedShortAttribute(t);
      a.addValue(moveOriginatorMessageID);
      list.put(t, a);
    }
