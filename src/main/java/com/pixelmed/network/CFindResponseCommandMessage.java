 ...
 * @author	dclunie
 */
class CFindResponseCommandMessage implements CommandMessage {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/network/CFindResponseCommandMessage.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
