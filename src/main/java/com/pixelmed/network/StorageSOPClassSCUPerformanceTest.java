...
public class StorageSOPClassSCUPerformanceTest extends StorageSOPClassSCU {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/network/StorageSOPClassSCUPerformanceTest.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
...
System.err.println("adding pair of SOP Class "+affectedSOPClass+" and Transfer Syntax "+inputTransferSyntax);
