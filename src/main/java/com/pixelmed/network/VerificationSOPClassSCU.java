...
public class VerificationSOPClassSCU extends SOPClass {
	...
	/***/
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/network/VerificationSOPClassSCU.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
...
if (debugLevel > 0) System.err.println("VerificationSOPClass: got PDU, now releasing association");
	...
	public static void main(String arg[]) {
		try {
			boolean secure = arg.length >= 5 && arg[4].toUpperCase().equals("SECURE");
