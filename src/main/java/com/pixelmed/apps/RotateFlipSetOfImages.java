...
public class RotateFlipSetOfImages {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/apps/RotateFlipSetOfImages.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
	...
	public static void main(String arg[]) {
		try {
			if (arg.length == 5) {
				...
				new RotateFlipSetOfImages(Integer.parseInt(arg[0]),arg[1].toUpperCase().contains("Y"),arg[2].toUpperCase().contains("Y"),arg[3],arg[4],logger);
			}
			else {
