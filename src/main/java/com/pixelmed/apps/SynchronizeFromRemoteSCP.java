...
public class SynchronizeFromRemoteSCP {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/apps/SynchronizeFromRemoteSCP.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
	...
	public static void main(String arg[]) {
		try {
			if (arg.length >= 7 && arg.length <= 11) {
				...
				boolean useGet = arg.length > 7 ? (arg[7].trim().toUpperCase().equals("GET") ? true : false) : false;
				boolean queryAll = arg.length > 8 ? (arg[8].trim().toUpperCase().equals("ALL") ? true : false) : true;
