...
class AppletDisplayRequestHandler extends RequestHandler {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/web/AppletDisplayRequestHandler.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
