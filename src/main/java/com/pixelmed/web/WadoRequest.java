...
public class WadoRequest extends WebRequest {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/web/WadoRequest.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
	...
	public boolean isContentTypeDicom() {
		return contentTypes != null
		    ...
		    && contentTypes[0][0].toLowerCase().equals("application/dicom");
	}
