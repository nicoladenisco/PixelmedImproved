...
class ImageDisplayRequestHandler extends RequestHandler {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/web/ImageDisplayRequestHandler.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
...
if (webServerDebugLevel > 1) System.err.println("ImageDisplayRequestHandler.generateResponseToGetRequest(): windowCenter="+windowCenter);
...
if (webServerDebugLevel > 1) System.err.println("ImageDisplayRequestHandler.generateResponseToGetRequest(): windowWidth="+windowWidth);
