...
class PathRequestHandler extends RequestHandler {
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/web/PathRequestHandler.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
...
if (webServerDebugLevel > 0) System.err.println("PathRequestHandler.generateResponseToGetRequest(): Was asked for requestPath "+requestPath);
			...
			if (requestPath.equals("/") || requestPath.toLowerCase().equals("/index.html") || requestPath.toLowerCase().equals("/index.htm")) {
