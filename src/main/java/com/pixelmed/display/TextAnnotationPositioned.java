...
/**
 * <p>
 * A class to encapsulate a text annotation positioned left or right and top or bottom with row offset relative to an abstract rectanglular frame.</p>
 *
 * @author	dclunie
 */
public class TextAnnotationPositioned
{
  private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/display/TextAnnotationPositioned.java,v 1.1.1.1 2011-05-21 10:08:47 nicola Exp $";
  ...
  /**
   * <p>
   * Get the text of the annotation.</p>
   *
  ...
  /**
   * <p>
   * Get the position relative to the left or right of the frame.</p>
   *
  ...
  /**
   * <p>
   * Get the position relative to the top or bottom of the frame.</p>
   *
