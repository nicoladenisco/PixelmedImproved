...
public class IconListBrowser
{
  ...
  protected ArrayList<IconListBrowserListener> arListeners = new ArrayList<IconListBrowserListener>();
  ...
  {
    // is the default, but just to be sure; note that on Mac use CMD-click not CTRL-click for discontiguous multi-selection
    this(iconSize, ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
  }

  public IconListBrowser(int iconSize, int selectionMode)
     throws DicomException
  {
    ...
    MouseListener mouseListener = new MouseAdapter()
    {
      ...
      public void mouseClicked(MouseEvent e)
      {
        if(e.getClickCount() > 0)
        {
          ...
          for(IconListBrowserListener l : arListeners)
          {
            l.selectionChange(e.getClickCount(), clickedIndex, selectedIndices);
          }
        }
      }
    };
   ...
   * @exception	DicomException		thrown if the icons cannot be extracted
   */
  public IconListBrowser(JScrollPane parentScrollPane, int iconSize)
     throws DicomException
  {
    this(iconSize);
   ...
   * @exception	IOException				thrown if a file cannot be read
   */
  public IconListBrowser(JScrollPane parentScrollPane, String[] dicomFileNames)
   ...
   * @exception	IOException				thrown if a file cannot be read
   */
  public IconListBrowser(Container content, String[] dicomFileNames)
     throws DicomException, FileNotFoundException, IOException
  {
   ...
   * @exception	IOException				thrown if a file cannot be read
   */
  public IconListBrowser(JFrame frame, String[] dicomFileNames)
     throws DicomException, FileNotFoundException, IOException
  {
     ...
     throws DicomException, FileNotFoundException, IOException
  {
    ...
    ConsumerFormatImageMaker.convertFileToEightBitImage(
       ...
       ICON_QUALITY,
       showAnnotations ? ConsumerFormatImageMaker.ICON_ANNOTATIONS : null,
       0/*debugLevel*/);
  ...
  public void addListener(IconListBrowserListener l)
  {
    arListeners.add(l);
  }

  public void removeListener(IconListBrowserListener l)
  {
