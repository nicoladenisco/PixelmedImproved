...
public class DemographicAndTechniqueAnnotations {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/display/DemographicAndTechniqueAnnotations.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
...
//System.err.println("Was not a sequence attribute");
							...
							if (value != null && value.length() > 0) {
								if (le.specialFunction == TEXTIFYESNO) {
									value = value.toUpperCase().indexOf("Y") == -1 ? "" : le.text;
								}
