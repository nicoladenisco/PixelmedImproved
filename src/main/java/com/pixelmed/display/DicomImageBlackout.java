...
public class DicomImageBlackout extends JFrame  {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/display/DicomImageBlackout.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
...
//System.err.println("DicomImageBlackout.addSingleImagePanelToMultiPanelAndEstablishLayout(): end imagePanel.getMaximumSize() = "+imagePanel.getMaximumSize());
	...
	protected void buildUIComponents() {
		...
		JButton blackoutApplyButton = new JButton("Apply");
		blackoutApplyButton.setToolTipText("Blackout the regions");
		blackoutButtonsPanel.add(blackoutApplyButton);
		blackoutApplyButton.addActionListener(new ApplyActionListener(this));
		
		JButton blackoutSaveButton = new JButton("Save");
		blackoutSaveButton.setToolTipText("Save the blacked-out image");
		blackoutButtonsPanel.add(blackoutSaveButton);
		blackoutSaveButton.addActionListener(new SaveActionListener(this));
		
		JButton blackoutNextButton = new JButton("Next");
		...
		blackoutNextButton.addActionListener(new NextActionListener(this));
