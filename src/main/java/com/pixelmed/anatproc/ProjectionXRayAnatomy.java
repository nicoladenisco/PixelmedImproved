...
public class ProjectionXRayAnatomy  {
	...
	private static final String identString = "@(#) $Header: /var/cvs-rep/pmedim/src/com/pixelmed/anatproc/ProjectionXRayAnatomy.java,v 1.1.1.1 2011-05-21 10:08:46 nicola Exp $";
	...
	static public DisplayableAnatomicConcept findAnatomicConcept(AttributeList list) {
...
if (anatomy != null) System.err.println("ProjectionXRayAnatomy.findAnatomicConcept(): found Anatomy in BodyPartExamined = "+anatomy.toStringBrief());
	...
	static public DisplayableViewConcept findView(AttributeList list) {
		// strategy is to look in specific attributes first, then general, and look in codes before free text ...
...
//if (view != null) System.err.println("ProjectionXRayAnatomy.findView(): found in BodyPartExamined = "+view.toStringBrief());
	...
	static public DisplayableLateralityConcept findLaterality(AttributeList list,DisplayableAnatomicConcept anatomy) {
...
if (laterality != null) System.err.println("ProjectionXRayAnatomy.findLaterality(): found Laterality in ViewPosition = "+laterality.toStringBrief());
	...
	static public DisplayableConcept findAmongstGeneralAttributes(AttributeList list,DictionaryOfConcepts concepts,String[] badPhraseTriggers) {
